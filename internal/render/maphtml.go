...
func RenderMapHTML(doc *graph.Document, an analyze.Analysis, generatedAt string) string {
	...
	w("<input id=\"search\" type=\"search\" placeholder=\"search nodes…  ( / )\" autocomplete=\"off\">\n")
	...
	w("<div class=\"hint\">scroll = zoom · drag bg = pan · click node = copy path · dbl-click = fit</div>\n")
	w("<div id=\"toast\"></div>\n")
